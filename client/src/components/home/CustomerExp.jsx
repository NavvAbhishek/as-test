...
export default function CustomerExp() {
  return (
    <div className="min-w-screen min-h-screen flex items-center justify-center pt-10">
      <div className="w-full bg-gray-100 border-gray-200 px-5 pt-16 md:py-24 text-gray-800">
        <div className="w-full max-w-6xl mx-auto">
          <div className="text-center max-w-xl mx-auto">
            <h1 className="text-6xl md:text-7xl font-bold mb-5 text-green-800">
              What people <br />
              are saying.
            </h1>
            <h3 className="text-xl mb-5 font-light text-black">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
            </h3>
            <div className="text-center mb-10">
              <span className="inline-block w-1 h-1 rounded-full bg-green-800 ml-1"></span>
              <span className="inline-block w-3 h-1 rounded-full bg-green-800 ml-1"></span>
              <span className="inline-block w-40 h-1 rounded-full bg-green-800"></span>
              <span className="inline-block w-3 h-1 rounded-full bg-green-800 ml-1"></span>
              <span className="inline-block w-1 h-1 rounded-full bg-green-800 ml-1"></span>
            </div>
          </div>
